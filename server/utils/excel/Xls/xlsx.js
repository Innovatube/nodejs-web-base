...
function parse_EncInfoExt() { throw new Error("Xls file with password is not supported"); }
...
wb.opts.Date1904 = Workbook.WBProps.date1904 = val; break;
				...
				case 'FilePass':
					...
					opts.enc = val;
					if(!options.password) throw new Error("Xls file with password is not supported");
					if(val.valid == null) throw new Error("Xls file with password is not supported");
					if(!val.valid) throw new Error("Xls file with password is not supported");
					break;
